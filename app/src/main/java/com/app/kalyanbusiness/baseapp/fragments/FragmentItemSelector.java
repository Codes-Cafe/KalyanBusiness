...
import com.app.kalyanbusiness.baseapp.adapter.AdapterListItemEmployeeSelector;
...
public class FragmentItemSelector extends BaseBottomSheetDialog {
    ...
    TextView tvTitle, tvNoRecordFound;
    Button btnSelect;
    Button btnAddNew;
    EditText etSearch;
    ...
    public void onCreateView(View view) {
        ...
        if (GenericUtils.isStringEmpty(title))
    ...
    protected void setListeners() {
        ...
        contCancel.setOnClickListener(v -> this.dismiss());
    ...
    private void initAdapter() {
        adapterEmployees = new AdapterListItemEmployeeSelector(getActivity(),
                employees, (requstingViewId, employee) -> {
