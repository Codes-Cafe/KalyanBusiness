...
import com.app.kalyanbusiness.baseapp.interfaces.FilePickListener;
...
public class ViewUtils {
    ...
    public static void showImageSourceSelectorDialog(Activity activity, int imageCount, boolean pickDocuments,
        ...
        addItemToBottomSheetDialog(builder, R.string.pick_from_gallery, android.R.drawable.ic_menu_gallery);
        builder.setTitle("");
        //addItemToBottomSheetDialog(builder, R.string.pick_from_camera, android.R.drawable.ic_menu_camera);
        ...
        bottomSheet.setOnItemClickListener((parent, view, position, id) -> {
            switch (position) {
                //case 0:
                  //  filePickListener.onPickFromCamera();
